...
architecture for a MeetStream bot. Read `{baseDir}/../../references/BOT-BUILDING.md`
before selecting a pattern.

Run `{baseDir}/../../scripts/doctor.sh` first. For a real launch, require an
...
more data. Use `{baseDir}/../../scripts/send-bot.sh`; never construct a raw
